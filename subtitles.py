...
if __name__ == '__main__':
    ...
    print('Unique words: ', len(document.original_list))
    document.unknown_words()
    document.find_similar_words()
    document.save_translate()
    print('Words to learn: ', len(document.final_unknown_words))
    print(f'Your vocabulary was created. File name: {document.ORIGINAL_SUBTITLES}_translate.txt')
